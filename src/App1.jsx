...
const PLANS = [
  ...
  },
  {
    name: 'Standar',
    sub: 'Company Profile',
    price: 4500000, // turun posisi, naik value
    hot: false,
    feats: [
      'Sampai 5 halaman',
...
const RATE_ROWS = [
  { p: 'Landing Page', d: '1 halaman fokus konversi', partner: 'Rp 3.500.000', sell: 'Rp 7–9 jt', margin: '~2x' },
  { p: 'Company Profile', d: 'Profil bisnis profesional multi-halaman', partner: 'Rp 6.000.000', sell: 'Rp 12–15 jt', margin: '~2x' },
  { p: 'Website Custom', d: 'Fitur sesuai kebutuhan klien', partner: 'Rp 9.000.000', sell: 'Rp 18–25 jt', margin: '~2x' },
    ...
    <>
      <main className="ppage">
        ...
        <section className="sec">
          <div className="wrap">
            <SecHead no="01" kicker="Rate Card" title="Harga partner & potensi margin Anda" desc="Ini harga bersih untuk Anda. Jual dengan harga Anda sendiri — selisihnya 100% milik Anda." />
            <Rv>
        ...
        <section className="sec pp-rules">
          <div className="wrap">
            <SecHead no="02" kicker="Aturan Main" title="Main bersih, dua-duanya menang" />
            <div className="rules-grid">
              {RULES.map((r, i) => (
                <Rv key={r.n} delay={i * 90}>
